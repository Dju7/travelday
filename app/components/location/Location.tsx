...
const handleRent = () => {
  ...
  } else if ( vehicule && modele && vehiculePrice) {
    const newLocation: Rent = {
      isRent: isRent,
      vehicule: vehicule,
      modele: modele,
  ...
  return (
    <article className='flex flex-col w-[80%] lg:w-[40%] h-[350px] bg-blue-200'>
        ...
        <div className='h-[30%] mt-6 w-full flex flex-col justify-center mt-4 items-center gap-4'>
          <label className='text-xl text-blue-800'>Location d'un véhicule ?</label>
        ...
        <div className='h-[55%] w-full flex flex-col justify-center items-center gap-4'>
          ...
          <div className='flex gap-14 items-center mt-6'>
            <button onClick={handleRent} disabled={!isRent} className=' w-32 mt-2 bg-blue-800 text-white shadow-lg shadow-blue-500 hover:bg-purple-400 p-2'>valider</button>
