...
export default function CardTrip({title, date, duration}: any) {
  return (
    <article className="z-20 h-[370px] w-[350px] border border-white p-2 flex flex-col bg-gradient-to-t from-cyan-500 to-blue-500 rounded-xl transform transition hover:scale-105 ">
