...
export default function Home() {
  return (
    ...
    <main className=" bg-accueil bg-cover bg-center" >
      ...
      <h2 className="text-4xl font-bold text-purple-500 ml-[450px]">Plannifiez vos voyages</h2>
      </div>
      <div className="h-[15%] w-full flex justify-center items-center">
        <form className="w-[70%] h-[40%] flex justify-center gap-8 ">
          <input className="w-[30%] h-full p-2 rounded-xl border-2 border-sky-400 outine-none " placeholder="entrez votre adresse e-mail"/>
          <input className="w-[30%] h-full p-2 rounded-xl border-2 border-red-500 outline-none" placeholder="entrez un mot de passe"/>
